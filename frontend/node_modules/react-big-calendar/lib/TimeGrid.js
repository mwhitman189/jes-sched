      ...
      return range.map(function (date, jj) {
        ...
        return resources.map(function (_ref, i) {
          ...
          if (resource.isPartTime) {
            console.log(partTimerCount)
            partTimerCount++;
          }
          var daysEvents = (groupedEvents.get(id) || []).filter(function (event) {
            return dates.inRange(date, accessors.start(event), accessors.end(event), 'day');
          });
          return !resource.isPartTime ? _react.default.createElement(_DayColumn.default, (0, _extends2.default)({}, _this2.props, {
            localizer: localizer,
          ...
          })) : partTimerCount < 2 && _react.default.createElement(_DayColumn.default, (0, _extends2.default)({}, _this2.props, {
            localizer: localizer,
            min: dates.merge(date, min),
            max: dates.merge(date, max),
            resource: resource && id,
