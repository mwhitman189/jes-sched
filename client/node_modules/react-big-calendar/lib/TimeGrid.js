  ...
  _proto.renderEvents = function renderEvents(range, events, now) {
    ...
    return range.map(function (date, jj) {
      ...
      if (partTimeResources.length > 0) {
        ...
        mappedResources.push(_react.default.createElement("div", {
          style: {display: "flex", flex: "1 1", borderRight: "2px solid black"},
          className: "rbc-day-slot rbc-time-column last-column"
