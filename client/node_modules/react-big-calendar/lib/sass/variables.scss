...
$text: #fff !default;
$text-2: #444444 !default;

$calendar-border: #DDD !default;
$cell-border: #DDD !default;
$cell-border-2: rgba(#444444, .7) !default;
...
$time-selection-bg-color: rgba(158, 106, 106, 0.5) !default;
$date-selection-bg-color: rgba(0,0,0, .10) !default;


$event-bg: #3e6cde !default;
$event-bg-2: #e6ba1f !default;
$event-bg-3: #7d6bd5 !default;
$event-bg-4: #4da18f !default;
...
$today-highlight-bg: #f5f0f0 !default;
